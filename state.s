...
CTFB_F4:
	...
	.text
	.globl	resourcesFinalize
	.type	resourcesFinalize, @function
resourcesFinalize:
.LFB0:
	.file 1 "state.c"
	.loc 1 9 39
	...
	.loc 1 10 16
	movq	-8(%rbp), %rax
	leaq	resourcesFinalize(%rip), %rdx
	movq	%rdx, 8(%rax)
	.loc 1 11 12
	movq	-8(%rbp), %rax
	leaq	resourcesFree(%rip), %rdx
	movq	%rdx, 16(%rax)
	.loc 1 12 13
	movq	-8(%rbp), %rax
	leaq	resourcesClean(%rip), %rdx
	movq	%rdx, 24(%rax)
	.loc 1 15 16
	movq	-8(%rbp), %rax
	movq	$0, 40(%rax)
	...
	addq	$64, %rax
	movq	%rax, %rdi
	call	arr_Finalize_obj_ship@PLT
	.loc 1 22 8
	movq	-8(%rbp), %rax
	.loc 1 22 2
	leave
	...
	.cfi_endproc
.LFE0:
	.size	resourcesFinalize, .-resourcesFinalize
	.section	.rodata
.LC0:
	.string	"nullpointer error at %s %p"
	.text
	.globl	resourcesFree
	.type	resourcesFree, @function
resourcesFree:
.LFB1:
	.loc 1 25 35
	.cfi_startproc
	...
	testq	%rax, %rax
	jne	.L4
	.loc 1 26 13 discriminator 1
	movq	stderr(%rip), %rax
	leaq	-8(%rbp), %rdx
	movq	%rdx, %rcx
	leaq	__func__.4636(%rip), %rdx
	leaq	.LC0(%rip), %rsi
	movq	%rax, %rdi
	movl	$0, %eax
	call	fprintf@PLT
...
.L4:
	...
	.cfi_endproc
.LFE1:
	.size	resourcesFree, .-resourcesFree
	.globl	resourcesClean
	.type	resourcesClean, @function
resourcesClean:
.LFB2:
	.loc 1 33 36
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE2:
	.size	resourcesClean, .-resourcesClean
	.globl	resourcesCopy
	.type	resourcesCopy, @function
resourcesCopy:
.LFB3:
	.loc 1 39 35
	.cfi_startproc
...
.L13:
	...
	.cfi_endproc
.LFE3:
	.size	resourcesCopy, .-resourcesCopy
	.section	.rodata
	.align 8
.LC1:
	...
	.align 8
.LC2:
	.string	"parsErr %s wrong node type %s\n"
.LC3:
	.string	"vers"
.LC4:
	.string	"value is not a number\n"
.LC5:
	.string	"shipTemplates"
.LC6:
	.string	"\t JSON passed to  %s\n"
.LC7:
	.string	"\t JSON after ship  %s\n"
	.text
	.globl	resourcesParse
	.type	resourcesParse, @function
resourcesParse:
.LFB4:
	.loc 1 49 53
	.cfi_startproc
	...
	testq	%rax, %rax
	jne	.L15
	.loc 1 50 13 discriminator 1
	movq	stderr(%rip), %rax
	leaq	-56(%rbp), %rdx
	movq	%rdx, %rcx
	leaq	__func__.4650(%rip), %rdx
	leaq	.LC0(%rip), %rsi
	movq	%rax, %rdi
	movl	$0, %eax
	call	fprintf@PLT
	.loc 1 50 56 discriminator 1
	movl	$1, %edi
	call	exit@PLT
.L15:
	.loc 1 51 5
...
.L23:
	...
	movq	%rax, %rdi
	call	json_next@PLT
	.loc 1 85 32 discriminator 1
	cmpl	$8, %eax
	jne	.L26
	.loc 1 85 78 discriminator 2
	movq	-64(%rbp), %rax
	movq	%rax, %rdi
	call	json_get_number@PLT
	.loc 1 85 66 discriminator 2
	movq	-56(%rbp), %rax
	.loc 1 85 73 discriminator 2
	cvttsd2sil	%xmm0, %edx
	.loc 1 85 72 discriminator 2
	movl	%edx, 60(%rax)
	.loc 1 85 3 discriminator 2
	jmp	.L24
.L26:
	.loc 1 85 115 discriminator 3
	movq	-64(%rbp), %rax
	movq	%rax, %rdi
	call	json_get_position@PLT
	movq	%rax, %rbx
...
.L18:
	...
	.cfi_endproc
.LFE4:
	.size	resourcesParse, .-resourcesParse
	.section	.rodata
	.align 8
.LC8:
...
.LC9:
	.string	"vers: %d\n"
.LC10:
	.string	"shipTeplates arr at %p:\n"
	.align 8
.LC11:
	.string	"\nEND of obj_resources at %p :\n"
	.text
	.globl	resources_Dump
	.type	resources_Dump, @function
resources_Dump:
.LFB5:
	.loc 1 124 36
	.cfi_startproc
	...
	testq	%rax, %rax
	jne	.L40
	.loc 1 125 13 discriminator 1
	movq	stderr(%rip), %rax
	leaq	-8(%rbp), %rdx
	movq	%rdx, %rcx
	leaq	__func__.4686(%rip), %rdx
	leaq	.LC0(%rip), %rsi
	movq	%rax, %rdi
	movl	$0, %eax
	call	fprintf@PLT
...
.L40:
	...
	.cfi_endproc
.LFE5:
	.size	resources_Dump, .-resources_Dump
	.section	.rodata
	.align 8
	.type	__func__.4636, @object
	.size	__func__.4636, 14
__func__.4636:
	.string	"resourcesFree"
	.align 8
	.type	__func__.4640, @object
	.size	__func__.4640, 15
__func__.4640:
	.string	"resourcesClean"
	.align 8
	.type	__func__.4644, @object
	.size	__func__.4644, 14
__func__.4644:
	.string	"resourcesCopy"
	.align 8
	.type	__func__.4650, @object
	.size	__func__.4650, 15
__func__.4650:
	.string	"resourcesParse"
	.align 8
	.type	__func__.4686, @object
	.size	__func__.4686, 15
__func__.4686:
	.string	"resources_Dump"
	.text
.Letext0:
